...
public class FirstStringExample {
    ...
    public static void main(String[] args) {
        ...
        //== compares hash codes and not content //shallow comparison : memory locations checked 
          if(str3==str4) 
          {
        ...
        String s6=  s5.toUpperCase(); //using new object
        
        System.out.println("s5 in upper case is: " + s6);
